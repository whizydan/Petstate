package com.example.petstate.messenger;
...
public class ChatActivity extends AppCompatActivity {
  ...
  private String chattingalready;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    db.child(vetid).addValueEventListener(new ValueEventListener() {
      @Override
      public void onDataChange(@NonNull DataSnapshot snapshot) {
        tinydb.putString("chattingwithvet", "false");
