...
import com.example.petstate.adapters.*
...
class Welcome : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        save.setOnClickListener {
            val id = u_id.getText().toString()
            val name = u_name.getText().toString()
            val email = u_email.getText().toString()
